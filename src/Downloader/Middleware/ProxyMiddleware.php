...
use BlackSpider\Downloader\Proxy\ArrayConfigurationLoader;
use BlackSpider\Downloader\Proxy\ConfigurationLoaderInterface;
use BlackSpider\Downloader\Proxy\Proxy;
