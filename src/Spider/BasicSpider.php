...
use BlackSpider\Downloader\Middleware\RequestDeduplicationMiddleware;
use BlackSpider\Extensions\LoggerExtension;
use BlackSpider\Extensions\StatsCollectorExtension;
use BlackSpider\Spider\Configuration\ArrayLoader;
